...
export default {
   ...
   methods: {
       ...
       checkLogisics(order) {
            ...
            // location.href = "https://test.e-shequ.com/weixin/orderpays.html?start=123#/logistice?com="+logisticName+"&nu="+order.logisticNo+"&type="+order.orderType+"&code="+order.logisticCode;
