<template>
   <div class="ind"> 
        ...
        <div class="info-wrap" style="overflow:hidden; clear: both; border-bottom:none ;">
             <!-- 链接地址要换 -->
            <a :href="this.config.person_index.url1+'?#/orders'" class="input-wrap menu-person-link lite-divider">
...
.logo2 {
background-image: url("../assets/images/icon_person_tuangou.png");
}
.logo3 {
 background-image: url("../assets/images/icon_person_yuyue.png");
} 
